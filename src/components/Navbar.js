...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white p-5 md:p-11 md:px-20 fixed top-0 left-0 w-full z-50 shadow-md">
        <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-4 md:text-2xl text-darkblue">
                <a href="#" className="hover:bg-blue-50 p-2 rounded">Ik huur</a>
                <a href="#" className="hover:bg-blue-50 p-2 rounded">Ik zoek</a>
                <a href="#" className="hover:bg-blue-50 p-2 rounded">Over ons</a>
                <a href="#" className="hover:bg-blue-50 p-2 rounded">Projecten</a>
            </div>

            {/* navbar icons */}
            <div className="hidden lg:flex items-center space-x-8 text-lg lg:text-xl">
                <div>
        ...
        {isOpen && (
            <div className="md:hidden mt-4 space-y-2 text-darkblue">
                ...
                <a href="#" className="block hover:bg-blue-700 p-2 rounded">About</a>
                <a href="#" className="block hover:bg-blue-700 p-2 rounded">Services</a>
                <a href="#" className="block hover:bg-blue-700 p-2 rounded">Contact</a>
